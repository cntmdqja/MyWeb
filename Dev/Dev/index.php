	...
	<div id="indexDiv" class="middleDiv">        
        <div class="main">
            ...
            <div class="right">
				...
				<br />
            	<p>Hello there. My name is Steve Choo, well my real name is Seungbeom but no one can pronounce it anyway. Welcome to my E-Portfolio. It's made up of HTML, CSS, PHP, and Javascript (JQuery). I guess that's pretty obvious though.</p>
